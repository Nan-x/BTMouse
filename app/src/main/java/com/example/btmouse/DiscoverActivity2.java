...
public class DiscoverActivity2 extends AppCompatActivity implements AdapterView.OnItemClickListener{
...
//        unregisterReceiver(mBroadcastReceiver4);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvNewDevices.setOnItemClickListener(DiscoverActivity2.this);
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(DiscoverActivity2.this);
